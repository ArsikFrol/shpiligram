...
import { ArrowLeft, BrushCleaning, CircleUser, Images, Volume2 } from "lucide-react"
...
import EmptyTopContantChat from "../Chat/TopContantChat/EmptyTopContantChat"
...
export default function TopContant() {
    ...
    const userIdProfile = searchParams.get('userId')!

    const { objProfile, loadingProfileHookFetch } = useFetchProfile(userIdProfile)
    ...
    if (loadingProfileHookFetch) return <SkeletonTopContentChat />
