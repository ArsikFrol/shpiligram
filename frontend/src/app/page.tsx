...
const listChats: TElemChat[] = [
    { id: '1', nameProfil: "Alice Johnson", logoProfil: "https://i.pravatar.cc/150?img=1", lastMessage: "Hey, how are you doing today?", timeSend: "09:42", pinned: false, countUnreadMessages: 2, recentlyOnline: "Online" },
    ...
    { id: '4', nameProfil: "Diana Prince", logoProfil: "https://i.pravatar.cc/150?img=4", lastMessage: "Thanks for your help!", timeSend: "14:30", pinned: false, countUnreadMessages: 0, recentlyOnline: "Online" },
    ...
    { id: '8', nameProfil: "Hannah Montana", logoProfil: "https://i.pravatar.cc/150?img=8", lastMessage: "Best of both worlds!", timeSend: "Thu", pinned: false, countUnreadMessages: 8, recentlyOnline: "2 hours ago" },
    ...
    { id: '12', nameProfil: "Laura Palmer", logoProfil: "https://i.pravatar.cc/150?img=12", lastMessage: "I'll be there in 10 minutes", timeSend: "13:45", pinned: false, countUnreadMessages: 0, recentlyOnline: "Online" },
    ...
    { id: '16', nameProfil: "Peter Parker", logoProfil: "https://i.pravatar.cc/150?img=16", lastMessage: "With great power comes great responsibility", timeSend: "Mon", pinned: false, countUnreadMessages: 3, recentlyOnline: "Online" },
    ...
    { id: '19', nameProfil: "Sarah Connor", logoProfil: "https://i.pravatar.cc/150?img=19", lastMessage: "Come with me if you want to live", timeSend: "Wed", pinned: false, countUnreadMessages: 0, recentlyOnline: "Online" },
    ...
    { id: '21', nameProfil: "Uma Thurman", logoProfil: "https://i.pravatar.cc/150?img=21", lastMessage: "Revenge is never a straight line", timeSend: "08:00", pinned: true, countUnreadMessages: 1, recentlyOnline: "Online" },
    { id: '22', nameProfil: "Violet Baudelaire", logoProfil: "https://i.pravatar.cc/150?img=22", lastMessage: "The world is quiet here", timeSend: "Fri", pinned: true, countUnreadMessages: 0, recentlyOnline: "5 hours ago" },
